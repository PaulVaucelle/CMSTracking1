...
//  f1 = new TFile("../outputUP/TTbar_TuneCP5_14TeV-pythia8_Phase2Spring21DRMiniAOD-PU200Phase2D76_113X_mcRun4_realistic_v7_nt_PVok_ptGT15_JP.root");
//  f2 = new TFile("../outputUP/TTbar_TuneCP5_14TeV-pythia8_Phase2Spring21DRMiniAOD-PU200Phase2D80_113X_mcRun4_realistic_T25_nt_PVok_ptGT15_JP.root");
//  f3 = new TFile("../outputUP/TTbar_TuneCP5_14TeV-pythia8_Phase2Spring21DRMiniAOD-PU200Phase2D81_113X_mcRun4_realistic_T26_nt_PVok_ptGT15_JP.root");
...
///////////////////////////////Boosted tree variables/////////////////////////////

TString htitle = "hTkSim_pt";  
TString htitle2 = "hTkSim_pt";
TString htitle3 = "hTkSim_pt";
TString htitle4 = "hTkSim_pt";
...
// TString htitle3 = "hTkSim_era";
// TString htitle4 = "hTkSim_eta";
//  TString xtitle = "eta"; 
//  int nbin = 50; 
//  float xmin = -2.5;
//  float xmax = 2.5;
...
// TString htitle3 = "hTkSim_dr";
// TString htitle4 = "hTkSim_dr";
//  TString xtitle = "dr"; 
//  int nbin = 200; 
//  float xmin = 0;
//  float xmax = 10;
...
// TString htitle3 = "hTkSim_dd";
// TString htitle4 = "hTkSim_dd";
//  TString xtitle = "dd"; 
//  int nbin = 200; 
//  float xmin = 0;
//  float xmax = 50;
//  float ymin = 0.0000005; 
...
// TString htitle3 = "hTkSim_ddSig";
// TString htitle4 = "hTkSim_ddSig";
...
// TString htitle3 = "hTkSim_inJet";
// TString htitle4 = "hTkSim_inJet";
...
// TString htitle3 = "hTkSim_pix";
// TString htitle4 = "hTkSim_pix";
//  TString xtitle = "pix"; 
//  int nbin = 30; 
//  float xmin = -0.5;
//  float xmax = 25;
...
// TString htitle3 = "hTkSim_hit";
// TString htitle4 = "hTkSim_hit";
//   TString xtitle = "hit"; 
//  int nbin = 30; 
//  float xmin = -0.5;
//  float xmax = 29.5;
...
// TString htitle3 = "hTkSim_chi";
// TString htitle4 = "hTkSim_chi";
//  TString xtitle = "chi"; 
//  int nbin = 50; 
//  float xmin = 0.;
//  float xmax = 10.;
...
// TString htitle3 = "hTkSim_r1";
// TString htitle4 = "hTkSim_r1";
//  TString xtitle = "r1"; 
//  int nbin = 200; 
//  float xmin = 0.;
//  float xmax = 100.;
...
// TString htitle3 = "hTkSim_z1";
// TString htitle4 = "hTkSim_z1";
//  TString xtitle = "z1"; 
//  int nbin = 200; 
//  float xmin = 0;
//  float xmax = 100;
...
// TString htitle3 = "hTkSim_at10";
// TString htitle4 = "hTkSim_at10";
//  TString xtitle = "at10"; 
//  int nbin = 101; 
//  float xmin = -0.5;
//  float xmax = 100.5;//100.5
//  float ymin = 0.000001; 
//  float ymax = 0.07;// logy and not log x
...
// TString htitle3 = "hTkSim_at30";
// TString htitle4 = "hTkSim_at30";
//  TString xtitle = "at30"; 
//  int nbin = 101; 
//  float xmin = -0.5;
//  float xmax = 100.5;
...
// TString htitle3 = "hTkSim_at40";
// TString htitle4 = "hTkSim_at40";
//  TString xtitle = "at40"; 
//  int nbin = 101; 
//  float xmin = -0.5;
//  float xmax = 100.5;
...
TPad* pad1 = new TPad("pad1","This is pad1",0.03,0.28,0.99,0.96,21);
// TPad* pad2 = new TPad("pad2","This is pad2",0.36,0.28,0.66,0.96,21);
// TPad* pad3 = new TPad("pad3","This is pad3",0.69,0.28,0.99,0.96,21);

TPad* rap1 = new TPad("rap1","This is rap1",0.03,0.04,0.99,0.28,21);
// TPad* rap2 = new TPad("rap2","This is rap2",0.36,0.04,0.66,0.28,21);
// TPad* rap3 = new TPad("rap3","This is rap3",0.69,0.04,0.99,0.28,21);
...
//        h1->SetFillStyle(3345);
       h1->SetTitle("isFromLLP variables compared for the 4 samples ");
       h1->SetLineStyle(1);
       h1->SetLineWidth(3);
       ...
       f2->cd();
 TH1F* g2 = (TH1F*)gROOT->FindObject(htitle);
       g2->Sumw2();
...
//        h2->SetFillStyle(3354);
 ...
 TH1F* h3 = new TH1F("h3","",nbin,xmin,xmax);
       ...
       f4->cd();
 TH1F* g4 = (TH1F*)gROOT->FindObject(htitle);
       g4->Sumw2();
 TH1F* h4 = new TH1F("h4","",nbin,xmin,xmax);
  ...
  leg->SetHeader("bgctau : 70-50-30-10");
  leg->Draw();
  ...
  leg = new TLegend(0.78,0.69,0.99,0.94);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(0.05);
  leg->SetHeader("Samples");
  leg->AddEntry(h1," bgctau70","P");
  leg->AddEntry(h2," bgctau50","P");
  leg->AddEntry(h3," bgctau30","P");
  leg->AddEntry(h4," bgctau10","P");
  leg->Draw();
...
// *************************
 ...
 TH1F* r2= new TH1F("r2","",nbin,xmin,xmax);
       ...
       r2->GetYaxis()->SetTitle("tau531(0) / tau70");
...
//        f1->cd();
//        g1 = (TH1F*)gROOT->FindObject(htitle2);
//        g1->Sumw2();
...
//        f3->cd();
//        g3 = (TH1F*)gROOT->FindObject(htitle2);
//        g3->Sumw2();
...
//        f4->cd();
//        g4 = (TH1F*)gROOT->FindObject(htitle2);
//        g4->Sumw2();
...
//        f1->cd();
//        g1 = (TH1F*)gROOT->FindObject(htitle3);
//        g1->Sumw2();
//        h1 = new TH1F("h1","",nbin,xmin,xmax);
//        h1->Add(g1,h1,1/g1->Integral(0,nbin+1),0);
// //        h1->Draw("EHF"); 
...
//        f2->cd();
//        g2 = (TH1F*)gROOT->FindObject(htitle3);
//        g2->Sumw2();
//        h2 = new TH1F("h2","",nbin,xmin,xmax);
//        h2->Add(g2,h2,1/g2->Integral(0,nbin+1),0);
// //        h2->Draw("EHFsame"); 
...
//        f3->cd();
//        g3 = (TH1F*)gROOT->FindObject(htitle3);
//        g3->Sumw2();
//        h3 = new TH1F("h3","",nbin,xmin,xmax);
//        h3->Add(g3,h3,1/g3->Integral(0,nbin+1),0);
//        h3->Draw("Esame"); 
...
//        f4->cd();
//        g4 = (TH1F*)gROOT->FindObject(htitle3);
//        g4->Sumw2();
//        h4 = new TH1F("h4","",nbin,xmin,xmax);
//        h4->Add(g4,h4,1/g4->Integral(0,nbin+1),0);
//        h4->Draw("Esame"); 
